...
- Location: tests\monitorPurchasePage.spec.js:5:5
...
```ts
  ...
  24 |     //await expect(page.locator("//td[text()='ASUS Full HD']")).toHaveText('ASUS Full HD')
  25 |     await expect(page.locator("//h2[text()='Products']")).toHaveText('Products')
  26 |     await purchasePage.purchaseFn("sruthi","India","Bangaluru","123456","May","2026")
> 27 |     await expect(page.locator("//h2[text()='Thank you for your purchase!']")).toHaveText('Thank you for your purchase!')
     |                                                                               ^ Error: expect(locator).toHaveText(expected) failed
  28 | 
  29 | 
  30 | })
