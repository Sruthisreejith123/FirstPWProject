...
```
TypeError: signUpPage.signUpButton is not a function
```
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: Abhirammmm
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox "Password:" [ref=e15]: mm@2014
        - generic [ref=e17]:
...
```ts
  ...
  4  |     const signUpPage=new SignUpPage(page)
  5  |     await signUpPage.goto()
  6  | 
  7  |     await signUpPage.signUpFn("Abhirammmm","mm@2014")
  8  |     await signUpPage.clickSignUp()
> 9  |     await signUpPage.signUpButton()
     |                      ^ TypeError: signUpPage.signUpButton is not a function
  10 |     page.on('dialog',async dialog=>{ 
  11 |     await expect(dialog.message()).toBe('This user already exist.')
  12 |     await dialog.accept()
  13 |     await signUpPage.signUpClose()
  14 |     })
  15 | })
  16 | 
```