...
- Location: tests\loginPage.spec.js:22:5
...
```ts
  ...
  8  |    } 
  9  | async goto(){
  10 |     await this.page.goto("https://www.demoblaze.com/")
  11 |     }
  12 | async loginbutton(){
  13 |     this.loginButton.click()
  14 | }
...
> 16 |     await this.username.fill(username)
  ...
  18 |     }    
  19 | async clickLogin(){
  20 |     await this.loginClick.click()
  21 | }
  22 | }
```