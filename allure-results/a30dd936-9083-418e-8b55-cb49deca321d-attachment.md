...
```
Error: locator.click: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//a[text()='Cart')]' is not a valid XPath expression.
...
Call log:
  - waiting for locator('//a[text()=\'Cart\')]')
